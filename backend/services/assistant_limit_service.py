...
Голосовые ассистенты, созданные мастером Voksy AI Agent, в лимит НЕ входят —
...
def get_agent_owned_assistant_ids(db: Session, user_id: Any) -> Set[UUID]:
    """
    ID голосовых ассистентов, созданных мастером Voksy AI Agent.
    ...
    rows = db.query(
        ...
        AgentConfig.eleven_assistant_id,
