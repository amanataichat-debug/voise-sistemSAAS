...
- На дизайн-системе (`<body class="vf">`, каркас B из `design-system/03-layouts.md`): dashboard, agents,
  gemini/grok/fish/eleven-agents, knowledge-base, telephony, conversations, crm, crm-contact, settings,
