...
(function () {
  ...
  var MENU = [
    ...
    { section: 'sidebar.section_assistants', def: 'Голосовые ассистенты' },
    { href: '/static/agents.html', lucide: 'bot', label: 'sidebar.openai', def: 'OpenAI', id: 'agents-nav-item' },
    { href: '/static/gemini-agents.html', lucide: 'gem', label: 'sidebar.gemini', def: 'Gemini', id: 'gemini-agents-nav-item' },
    { href: '/static/fish-agents.html', lucide: 'fish', label: 'sidebar.fish', def: 'Fish Audio', id: 'fish-agents-nav-item',
      aliases: ['/static/fish-test.html'] },
    { href: '/static/eleven-agents.html', lucide: 'audio-lines', label: 'sidebar.elevenlabs', def: 'ElevenLabs', id: 'eleven-agents-nav-item',
