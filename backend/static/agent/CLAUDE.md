...
| `credits.js` | Кредиты и подписка оркестратора | `loadCredits`, `renderCreditsBadge`, `onSubAction`, `openCreditsModal`, `purchasePackage`, `subscribeAgent`, `openBillingModal`, `openFinikPayment` | `/api/credits/*` |
