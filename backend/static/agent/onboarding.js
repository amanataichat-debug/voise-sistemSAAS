...
const OB_SLIDES = [
  {
    ...
    text: 'Агент VoksiAI сам звонит по вашей базе, ведёт живой разговор, квалифицирует контакт и решает что делать дальше. Он заменяет первую линию продаж — а вы только ставите цели.',
