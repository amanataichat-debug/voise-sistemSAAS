# UI/UX Skill — Voksy AI Brand Style

Фирменный дизайн-гайд для всех веб-продуктов Voksy AI. Содержит цвета, типографику, компоненты и паттерны.
...
- Все веб-интерфейсы Voksy AI

---

## Фирменные цвета Voksy AI
